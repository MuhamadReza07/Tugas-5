...
<html lang="en">
   ...
   <body class="main-layout">
                  ...
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="text-bg">
                           ...
                           <figure><img src="{{ url('public') }}/images/banner_img.png" alt="#"/></figure>
      ...
      <div id="about" class="shop">
         <div class="container-fluid">
            <div class="row">
               <div class="col-md-5">
                  <div  class="shop_img">
                     <figure><img src="{{ url('public') }}/images/shop_img.png" alt="#"/></figure>
                  </div>
               </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="clients_box">
                                          <figure><img src="{{ url('public') }}/images/our.png" alt="#"/></figure>
                                          <h3>Sandy Mark</h3>
      ...
      <script>
         ...
         var image = '{{ url('public') }}/images/maps-and-flags.png';
